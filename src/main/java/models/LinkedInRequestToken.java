...
public class LinkedInRequestToken
{
	@Id
	@ObjectId
	private String id;
	...
	public LinkedInRequestToken(){}

	public LinkedInRequestToken(String id, String token, String tokenSecret,
			URI authorizationUrl, Date expirationTime)
	{
		super();
		this.id = id;
		this.token = token;
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		LinkedInRequestToken other = (LinkedInRequestToken) obj;
